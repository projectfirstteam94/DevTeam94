...
<table ID="dataList" class=" wordBreak">
                <?php
				$cmd = 'SELECT * FROM live ORDER BY live_value DESC , live_day DESC LIMIT 20 ';
        	...
        	<tr><td class="dataList_text"><h4><?php echo date( "Y.m.d H:i" , strtotime($liveDay)) .'　'.$liveTitle; ?></h4></td>
