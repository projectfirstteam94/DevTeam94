...
$text = htmlspecialchars($_SESSION['live']['内容テキスト'], ENT_QUOTES, 'UTF-8');
...
// 書き込み処理：お知らせ新規追加
if(!empty($_POST)){
	$sql = sprintf('INSERT INTO live SET live_day="%s", live_open="%s", live_close="%s", live_value="%d", live_title="%s", live_catch="%s", live_text="%s", live_text2="%s", live_address="%s", live_tel="%s", live_mail="%s", live_google="%s", live_url="%s", live_image1="%s"' ,
...
<form action="" method="post">
	...
	<div class="content70 wordBreak">
			...
			<p class="textRight"><?php echo date( "Y/m/d H:i" , strtotime($day) ); ?> 更新</p>
