<?php
require_once $_SERVER["DOCUMENT_ROOT"] . "/lib/contact/GeneralContactMail.php";
use hawaii\contact\GeneralContactMail;
?>
...
$BccMail = "test-mahalo@mail.kslink.work";
...
$require = array('お名前','フリガナ','メールアドレス','電話番号','お問い合わせ内容','内容');
...
if(($confirmDsp == 0 || $sendmail == 1) && $empty_flag != 1){
	...
	//メール送信処理前に内容を保存
	//---------------------------------
	$contactMailObj = new GeneralContactMail(
