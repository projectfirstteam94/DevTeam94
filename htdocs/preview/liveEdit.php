...
//ゲットチェック
$errorJump = "liveEdit.php?ID=1"; //エラーの際のジャンプ先指定
...
<div class="content50 textCenter"><button class="linkButton5" type="submit" name="action" value="delete" onClick="return confirm('削除してよろしいですか？');">削　　　除</button></div>
<div class="content50 textCenter"><button class="linkButton5" type="submit" name="action" value="update">上書き修正</button></div>
</form>
<br>


<a href="newsAdd.php"><input class="linkButton" type="button" value="お知らせの追加・編集はコチラ"></a>
